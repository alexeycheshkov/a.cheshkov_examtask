...
public class DBUtils {
    ...
    public static void connect() {
        try {
            ...
            connection = DriverManager.getConnection(Config.get("db_url"), Config.get("db_root_name"), Config.get("db_root_password"));
    ...
    public static void disconnect() {
        try {
            ...
            Logger.getInstance().debug("Сonnection cannot be disconnected",ex);
        }
    }
}
